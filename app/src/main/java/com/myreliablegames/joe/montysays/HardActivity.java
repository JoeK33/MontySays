...
public class HardActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton button2 = (ImageButton) findViewById(R.id.hardButton2);
        ImageButton button3 = (ImageButton) findViewById(R.id.hardButton3);
        ImageButton button4 = (ImageButton) findViewById(R.id.hardButton4);
